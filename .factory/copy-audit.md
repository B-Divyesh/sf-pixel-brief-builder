...
| Opens a finished 20-item packet. | 5 | Pass: adjacent result |
...
| Build my art packet | 4 | Pass: action |
| Rebuilding asks before it replaces a packet with finished marks. | 10 | Pass: declared claim |
| Your finite art list appears here | 6 | Pass: empty-state heading |
| Choose the four limits. | 4 | Pass |
| Then build an 18, 20, or 22-item packet. | 8 | Pass: declared claim |
...
| Your packet stays in this browser. | 6 | Pass: declared claim |
| No account, child profile, analytics, or outside script is used. | 10 | Pass: declared claims |
